...
public class NugetCustomManagementPackage
{
    ...
    public NugetCustomManagementPackage()
    {
        ...
        Packages = new Dictionary<string, string>
        {
            ...
            { "Nuuvify.CommonPack.AutoHistory", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.AzureStorage", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.AzureStorage.Abstraction", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.Domain", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.EF.Exceptions.Common", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.EF.Exceptions.Db2", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.EF.Exceptions.Oracle", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.Email", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.Email.Abstraction", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.Extensions", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.HealthCheck", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.Middleware", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.Middleware.Abstraction", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.OpenApi", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.Security", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.Security.Abstraction", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.Security.JwtCredentials", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.Security.JwtStore.Ef", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.UnitOfWork", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.UnitOfWork.Abstraction", "2.0.0-preview.24091906" },
            { "Nuuvify.CommonPack.StandardHttpClient", "2.0.0-preview.24091906" },
        };
