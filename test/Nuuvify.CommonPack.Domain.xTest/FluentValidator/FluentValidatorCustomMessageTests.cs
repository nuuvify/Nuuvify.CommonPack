...
public class FluentValidatorCustomMessageTests
{
    ...
    public void AssertContains()
    {
        ...
        _ = new ValidationConcernR<Customer>(_customer).AssertContains(x => x.Name, contem, message);
    ...
    public void AssertIsRequired()
    {
        ...
        _ = new ValidationConcernR<Customer>(_customer).AssertIsRequired(x => x.Name, message);
        Assert.Equal(message, _customer.Notifications.FirstOrDefault().Message);
    }
    ...
    public void AssertHasMinLength()
    {
        ...
        _ = new ValidationConcernR<Customer>(_customer).AssertHasMinLength(x => x.Name, 10, message);
    ...
    public void AssertHasMaxLength()
    {
        ...
        _ = new ValidationConcernR<Customer>(_customer).AssertHasMaxLength(x => x.Name, 1, message);
        Assert.Equal($"{message} {_customer.Name}", _customer.Notifications.FirstOrDefault().Message);
    }
    ...
    public void AssertIsFixedLength()
    {
        ...
        _ = new ValidationConcernR<Customer>(_customer).AssertFixedLength(x => x.Name, 5, message);
        Assert.Equal($"{message} {_customer.Name}", _customer.Notifications.FirstOrDefault().Message);
    }
    ...
    public void AssertMatches_Invalido()
    {
        ...
        _ = new ValidationConcernR<Customer>(_customer).AssertRegexIsMatches("^\\d{5}[-]\\d{3}$", name, _customer.Name, message);
        Assert.Equal(message, _customer.Notifications.FirstOrDefault().Message);
    }
    ...
    public void AssertMatchesNull_Invalido()
    {
        ...
        _ = new ValidationConcernR<Customer>(_customer).AssertRegexIsMatches("^\\d{5}[-]\\d{3}$", name, null, message);
        Assert.Equal(message, _customer.Notifications.FirstOrDefault().Message);
    }
    ...
    public void AssertIsEmail()
    {
        ...
        _ = new ValidationConcernR<Customer>(_customer).AssertIsEmail(x => x.Email, message);
    ...
    public void AssertNotAreEquals_DateTime()
    {
        ...
        _ = new ValidationConcernR<Customer>(_customer).AssertNotAreEquals(x => x.Birthdate, dataHora, message);
        Assert.Equal(message, _customer.Notifications.FirstOrDefault().Message);
    }
    ...
    public void AssertNotAreEquals_DateTimeOffset()
    {
        ...
        _ = new ValidationConcernR<Customer>(_customer).AssertNotAreEquals(x => x.Register, dataHora, message);
    ...
    public void AssertAreEquals_DateTime()
    {
        ...
        var dataHora = DateTime.Now;
        _customer.Birthdate = dataHora;
        _ = new ValidationConcernR<Customer>(_customer).AssertAreEquals(x => x.Birthdate, dataHora.AddDays(+1), message);
        Assert.Equal(message, _customer.Notifications.FirstOrDefault().Message);
    }
    ...
    public void AssertAreEquals_DateTimeOffset()
    {
        ...
        var dataHora = DateTimeOffset.Now;
        _customer.Register = dataHora;
        _ = new ValidationConcernR<Customer>(_customer).AssertAreEquals(x => x.Register, dataHora.AddDays(+1), message);
        Assert.Equal(message, _customer.Notifications.FirstOrDefault().Message);
    }
    ...
    public void AssertIsUrl()
    {
        ...
        _ = new ValidationConcernR<Customer>(_customer).AssertIsUrl(x => x.Url, message);
    ...
    public void AssertIsTelephone()
    {
        ...
        _ = new ValidationConcernR<Customer>(_customer).AssertIsTelephone(x => x.Telephone, message);
