...
public class DistinctExtensionTests
{
    ...
    public void Distinct_ComPropriedadesSelecionadas_DeveRetornarDistintos()
    {
        ...
        {
            new() { Id = "AA1", Nome = "Fritz", Codigo = 3 },
            new() { Id = "XX1", Nome = "Giropopis", Codigo = 1 },
            new() { Id = "XA2", Nome = "Stradivarius", Codigo = 2 },
            new() { Id = "XB1", Nome = "Giropopis", Codigo = 1 },
            new() { Id = "DDD", Nome = "Fritz", Codigo = 3 },
            new() { Id = "XC3", Nome = "Fulano", Codigo = 1 },
        };
