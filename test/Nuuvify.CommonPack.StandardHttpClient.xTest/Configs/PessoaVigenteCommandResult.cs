...
{
    internal class PessoaVigenteCommandResult : ICommandResultR
    {
    ...
    internal class RetornoPessoGenericoFornecedores
    {
        public IList<RetornoPessoaGenerico> Fornecedores { get; set; }
    }
    internal class RetornoPessoaGenerico
    {
        public string PFJ_CODIGO { get; set; }
        public string RAZAO_SOCIAL { get; set; }
        public DateTime DT_INICIO_PESSOA_VIGENCIA { get; set; }
    ...
    internal class CotacaoDolarDia
    {
        public IList<MoedaCotada> Value { get; set; }
    }

    internal class MoedaCotada
    {
