...
public static class HttpClientBuilderExtensions
{
        ...
        int breakDurationMilliSeconds = 5000)
    {
        ...
        var tokenService = sp.GetService<ITokenService>() ?? throw new TypeLoadException("A interface ITokenService não foi injetada no conteiner DI, a injeção dessa interface deve ocorrer antes da chamada desse metodo, veja o metodo AddStandardHttpClientSetup");
