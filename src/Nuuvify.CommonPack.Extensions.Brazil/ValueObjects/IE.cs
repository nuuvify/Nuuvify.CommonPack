...
public class IE : NotifiableR
{
    ...
    private static bool ValidaDF(string inscricaoEstadual)
    {
        ...
        for (var intPos = 12; intPos >= 1; intPos--)
        {
            _ = int.TryParse(strBase.Substring(intPos - 1, 1), out intValor);
            intValor *= intPeso;
            intSoma += intValor;
    ...
    private static bool ValidaPE(string inscricaoEstadual)
    {
        ...
        for (var intPos = 7; intPos >= 1; intPos--)
        {
            _ = int.TryParse(strBase.Substring(intPos - 1, 1), out intValor);
            intValor *= intPeso;
            intSoma += intValor;
        ...
        for (var intPos = 8; intPos >= 1; intPos--)
        {
            _ = int.TryParse(strBase.Substring(intPos - 1, 1), out intValor);
            intValor *= intPeso;
            intSoma += intValor;
    ...
    private static bool ValidaPR(string inscricaoEstadual)
    {
        ...
        for (var intPos = 9; intPos >= 1; intPos--)
        {
    ...
    private static bool ValidaSP(string inscricaoEstadual)
    {
        ...
        else
        {
            ...
            for (var intPos = 11; intPos >= 1; intPos--)
            {
                _ = int.TryParse(strBase.Substring(intPos - 1, 1), out int intValor);
                intValor *= intPeso;
                intSoma += intValor;
