...
namespace Nuuvify.CommonPack.Email.Abstraction
{
    public interface IEmail
    {
        ...
        /// <returns></returns>
        Task<object> EnviarAsync(Dictionary<string, string> recipients, Dictionary<string, string> senders, string subject, string message, CancellationToken cancellationToken = default);

        /// <summary>
        /// Retorna o template html informado, com as variaveis substituidas e pronto para ser utilizado no envio de email
        /// apenas de retornar string, a biblioteca de envio de email ira sempre converter para HTML
        /// </summary>
        ...
        /// <returns></returns>
        string GetEmailTemplate(Dictionary<string, string> variables, string templateFullName);
        ...
        /// <returns></returns>
        IEmail WithAttachment(string pathFileFullName, EmailMidiaType midiaType, EmailMidiaSubType midiaSubType);
